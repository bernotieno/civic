...
@extend_schema(
    ...
    **🇰🇪 Citizens submit feedback to their county government with full authentication**
    ...
    - **📊 Simple Submission** - Streamlined feedback process
        ...
        201: OpenApiResponse(
            ...
            examples=[
                OpenApiExample(
                    ...
                    description="Example of successful infrastructure feedback submission",
                    value={
                        "success": True,
...
def user_feedback_statistics(request):
    ...
    if detailed_stats is None:
        ...
        # Response time analysis removed
