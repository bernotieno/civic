              ...
              <div className="hidden lg:block lg:w-3/5 relative">
                ...
                <div className="relative z-10 p-12 h-full flex items-center">
                  <div className="text-white">
                    ...
                    <p className="text-teal-100 text-lg">Sign in to access your civic engagement platform</p>
                  </div>
                </div>
              </div>
              ...
              <div className="w-full lg:w-2/5 p-8 lg:p-12">
                <div className="w-full max-w-sm mx-auto space-y-8">
                  ...
                  <form className="space-y-6">
                    ...
                    <Button 
                      type="submit"
                      className="w-full h-12 bg-teal-500 hover:bg-teal-600 text-white font-semibold rounded-lg transition-colors duration-200"
                    >
                      Log In
                    </Button>
                  </form>
